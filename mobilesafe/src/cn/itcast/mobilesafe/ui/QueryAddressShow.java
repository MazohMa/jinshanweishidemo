...
public class QueryAddressShow extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.query_address_show);
		...
		cb_query_address_show1.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				if(isChecked){
					startService(intent);
					tv_query_address_show1.setText("查询地址服务已开启");
				}else{
					stopService(intent);
					tv_query_address_show1.setText("查询地址服务未开启");
				}
		...
		ll.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				View view = View.inflate(QueryAddressShow.this, R.layout.single_choice_dialog, null);
				...
				/**
				 * 点击归属地提示框风格，首先判断SharedPreferences里面是否保存了颜色，保存了就取出来
				 */
				...
				bt.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View v) {
						...
						if(colour==1){
							rb_single_choice_dialog1.setChecked(true);
							tv_query_address_show_colour.setText("半透明");
							return;
						}else if(colour==2){
							rb_single_choice_dialog2.setChecked(true);
							tv_query_address_show_colour.setText("活力橙");
							return;
						}else if(colour==3){
							rb_single_choice_dialog3.setChecked(true);
							tv_query_address_show_colour.setText("卫士蓝");
							return;
						}else if(colour==4){
							rb_single_choice_dialog4.setChecked(true);
							tv_query_address_show_colour.setText("金属灰");
							return;
						}else if(colour==5){
							rb_single_choice_dialog5.setChecked(true);
							tv_query_address_show_colour.setText("苹果绿");
							return;
						}
